...
parser.add_argument('--snapshot_dir', default='./snapshot_clr',
...
parser.add_argument('--iters', type=int, default=30*1000,
...
def minialexnet(data, labels=None, train=False, param=learned_param,
    ...
    n.pool4 = max_pool(n.relu4, 3, stride=2, train=train)
    n.fc5, n.relu5 = fc_relu(n.pool4, 1024, param=param)
    n.drop5 = L.Dropout(n.relu5, in_place=True)
    n.fc6, n.relu6 = fc_relu(n.drop5, 1024, param=param)
    n.drop6 = L.Dropout(n.relu6, in_place=True)
    preds = n.fc7 = L.InnerProduct(n.drop6, num_output=num_classes, param=param)
    if not train:
...
def eval_net(split, K=5):
    ...
    filename = 'top_%d_predictions_clr.%s.csv' % (K, split)
