...
def minialexnet(data, labels=None, train=False, param=learned_param,
    ...
    n.conv1, n.relu1 = conv_relu(n.data, 3, 32, pad=1, **conv_kwargs)
    n.conv2, n.relu2 = conv_relu(n.relu1, 3, 32, pad=1, **conv_kwargs)
    n.pool2 = max_pool(n.relu2, 2, stride=2, train=train)
    n.conv3, n.relu3 = conv_relu(n.pool2, 3, 64, pad=1, **conv_kwargs)
    n.conv4, n.relu4 = conv_relu(n.relu3, 3, 64, pad=1, **conv_kwargs)
    n.pool4 = max_pool(n.relu4, 2, stride=2, train=train)
    n.conv5, n.relu5 = conv_relu(n.pool4, 3, 128, pad=1, **conv_kwargs)
    n.conv6, n.relu6 = conv_relu(n.relu5, 3, 128, pad=1, **conv_kwargs)
    n.conv7, n.relu7 = conv_relu(n.relu6, 3, 128, pad=1, **conv_kwargs)
    n.pool7 = max_pool(n.relu7, 2, stride=2, train=train)
    n.conv8, n.relu8 = conv_relu(n.pool7, 3, 256, pad=1, **conv_kwargs)
    n.conv9, n.relu9 = conv_relu(n.relu8, 3, 256, pad=1, **conv_kwargs)
    n.conv10, n.relu10 = conv_relu(n.relu9, 3, 256, pad=1, **conv_kwargs)
    n.pool10 = max_pool(n.relu10, 2, stride=2, train=train)
    n.conv11, n.relu11 = conv_relu(n.pool10, 3, 256, pad=1, **conv_kwargs)
    n.conv12, n.relu12 = conv_relu(n.relu11, 3, 256, pad=1, **conv_kwargs)
    n.conv13, n.relu13 = conv_relu(n.relu12, 3, 256, pad=1, **conv_kwargs)
    n.pool13 = max_pool(n.relu13, 2, stride=2, train=train)
    n.fc14, n.relu14 = fc_relu(n.pool13, 4096, param=param)
    n.drop14 = L.Dropout(n.relu14, in_place=True) #assume ratio is 0.5 lol
    n.fc15, n.relu15 = fc_relu(n.drop14, 4096, param=param)
    n.drop15 = L.Dropout(n.relu15, in_place=True)

    preds = n.fc16 = L.InnerProduct(n.drop15, num_output=num_classes, param=param)
    if not train:
        # Compute the per-label probabilities at test/inference time.
        preds = n.probs = L.Softmax(n.fc16)
    if with_labels:
        n.label = labels
        n.loss = L.SoftmaxWithLoss(n.fc16, n.label)
