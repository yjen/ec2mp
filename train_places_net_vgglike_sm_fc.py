...
def minialexnet(data, labels=None, train=False, param=learned_param,
    ...
    n.conv1, n.relu1 = conv_relu(n.data, 3, 64, pad=1, **conv_kwargs)
    ...
    n.conv11, n.relu11 = conv_relu(n.pool10, 3, 512, pad=1, **conv_kwargs)
    n.conv12, n.relu12 = conv_relu(n.relu11, 3, 512, pad=1, **conv_kwargs)
    n.conv13, n.relu13 = conv_relu(n.relu12, 3, 512, pad=1, **conv_kwargs)
    n.pool13 = max_pool(n.relu13, 2, stride=2, train=train)
    n.fc14, n.relu14 = fc_relu(n.pool13, 2048, param=param)
    n.drop14 = L.Dropout(n.relu14, in_place=True) #assume ratio is 0.5 lol
    n.fc15, n.relu15 = fc_relu(n.drop14, 2048, param=param)
